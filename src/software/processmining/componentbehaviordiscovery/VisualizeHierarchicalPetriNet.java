...
public class VisualizeHierarchicalPetriNet {
	...
	public JComponent visualizeTop(PluginContext context, HierarchicalMultiinstancePetriNet hpn)
	{
	...
	public Dot convertCom2DOT(String componentName, HierarchicalMultiinstancePetriNet hpn)
	{
		Dot dot = new Dot();
		//dot.setDirection(GraphDirection.topDown);
		dot.setDirection(GraphDirection.leftRight);
		//dot.setDirection(GraphDirection.);
